...
import CustomLanguageDropdown from '../component/CustomSettingDropDown';
        ...
        <ImageBackground style={styles.container} source={require('../assets/bg3.jpg')} >
            <ScrollView>
                ...
                <View style={styles.inputContainer}>
                    <CustomLanguageDropdown selectedLanguage={language} accessibilityLabel="Select Language" placeholder="Select Language" selctedValue={(itemValue) => setLanguage(itemValue)} />
                    {/* <Picker
                        style={styles.input}
